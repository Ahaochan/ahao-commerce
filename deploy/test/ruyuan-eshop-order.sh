...
start_application() {
    ...
    nohup java -server -Xms6g -Xmx6g -Xss256k -XX:MetaspaceSize=256m -XX:NewRatio=2 -XX:+PrintTenuringDistribution -XX:+PrintHeapAtGC -XX:+UseConcMarkSweepGC -XX:+UseParNewGC  -XX:+UseCMSCompactAtFullCollection  -XX:CMSFullGCsBeforeCompaction=5 -XX:CMSInitiatingOccupancyFraction=70 -XX:+CMSClassUnloadingEnabled -XX:+PrintGCDetails -XX:+PrintGCDateStamps -Xloggc:/home/admin/application/gc-%t-%p.log -XX:+HeapDumpBeforeFullGC -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/home/admin/application/ -XX:+PrintClassHistogramBeforeFullGC -XX:+PrintClassHistogramAfterFullGC -XX:ErrorFile=/home/admin/application/hs_err_pid%p.log -jar ${JAR_NAME} --spring.cloud.nacos.config.server-addr=172.19.16.47:8848 --spring.profiles.active=masterslave > ${JAVA_OUT} 2>&1 &
